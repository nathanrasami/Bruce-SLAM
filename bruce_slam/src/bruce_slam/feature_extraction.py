...
class FeatureExtraction(object):
    ...
    def callback_cartesian(self, msg):
        ...
        # Sur le fan cartésien les colonnes ne sont PAS l'azimuth (les notes d'investigation §4) :
        ...
        # Publish visualization (non essentiel : protégé pour ne jamais casser le callback,
